...
class LineFinder(object):
    ...
    def find_lines(self, warped, original, name='lines.jpg', output_dir='./output_images', debug=False):
        """
    ...
    def process_image_ex(self, warped, original, combined, name='lines.jpg', output_dir='./output_images'):
        """
            Process the image and generates additional data output.
        """
        output, sw_output = self.find_lines(warped, original, name, output_dir, True)
